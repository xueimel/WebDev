    ...
    <header class="main-header">
        <nav class="nav main-nav">
            ...
            <div id="nav-container">
                <div class="left">
                    <a href="home.html">LOGO IN TRAINING</a>
                </div>

                <div class="center">
                    <ul>
                        <!-- unordered list-->
                        <li id="center-right"><a href="tickets.html">TICKETS</a></li>
                        <li id="center-left"><a href="about.html">CONTACT/part that refuses to work</a></li>
                    </ul>
                </div>
                <div class="right">
